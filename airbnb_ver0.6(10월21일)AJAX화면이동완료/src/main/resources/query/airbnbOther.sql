...
INSERT INTO ADDRESS (COUNTRY, STATE, CITY, STREET, OPTIONAL, ZIP_CODE, HOUSE_SEQ) VALUES ('한국','서울특별시','강남구','언주로406','35동 4층 407호','135-919', 12);
...
select * from houses
-- HOSTING 첫 번째 화면
INSERT INTO HOUSES (ROOM_TYPE, GUEST_CNT, EMAIL, REG_DATE, BUILDING_SEQ) VALUES('개인실',3,'hongs890@gmail.com','2016-10-16',1); 
-- HOSTING 두 번째 화면
UPDATE HOUSES SET BED_CNT = 2, BATHROOM_CNT = 2 WHERE HOUSE_SEQ = 12;
-- HOSTING 세 번째 화면
INSERT INTO ADDRESS (COUNTRY, STATE, CITY, STREET, OPTIONAL, ZIP_CODE, HOUSE_SEQ) VALUES ('한국','서울특별시','강남구','언주로406','35동 4층 407호','135-919', 2);
-- HOSTING 네 번째 화면
UPDATE ADDRESS SET LATITUDE = '124.12351', LONGITUDE = '125.52541' WHERE ADDRESS_SEQ = 5;
-- HOSTING 다섯 번째 화면 (편의시설 총 13종)
UPDATE HOUSES SET CONVENIENCE = 'T-F-T-F-F-F-T-F-T-F-F-T-F' WHERE HOUSE_SEQ = 12;
-- HOSTING 여섯 번째 화면 (안전시설 총 6종) 
UPDATE HOUSES SET SAFETY_FAC = 'T-T-T-T-F-F' WHERE HOUSE_SEQ = 12;
-- HOSTING 일곱 번째 화면 (공간제공 총 8종) 
UPDATE HOUSES SET SPACE = 'T-T-T-T-F-F-T-T' WHERE HOUSE_SEQ = 12;
-- HOSTING 여덟 번째 화면
UPDATE HOUSES SET PICTURE = 'default.jpg' WHERE HOUSE_SEQ = 12;
-- HOSTING 아홉 번째 화면
UPDATE HOUSES SET EXPLAINATION = '좋은 집' WHERE HOUSE_SEQ = 12;
-- HOSTING 열 번째 화면
UPDATE HOUSES SET TITLE = '오세요' WHERE HOUSE_SEQ = 2;
-- HOSTING 열한 번째 화면 (이용규칙 총 5종)
UPDATE HOUSES SET RULES = 'T-F-T-F-T', OTHER_RULE='고양이 금지' WHERE HOUSE_SEQ = 12;
-- HOSTING 열두 번째 화면
UPDATE HOUSES SET CHECKIN_TERM = 2, CHECKIN_TIME = '15:00' WHERE HOUSE_SEQ = 12;
-- HOSTING 열세 번째 화면
UPDATE HOUSES SET PERIOD ='2016-11-01' WHERE HOUSE_SEQ = 12;
-- HOSTING 열네 번째 화면
UPDATE HOUSES SET MIN_NIGHTS = 2, MAX_NIGHTS =3 WHERE HOUSE_SEQ = 12;
-- HOSTING 열다섯 번째 화면
UPDATE HOUSES SET PRICE = 50000 WHERE HOUSE_SEQ = 12;
------------------------ 2번째 호스팅
