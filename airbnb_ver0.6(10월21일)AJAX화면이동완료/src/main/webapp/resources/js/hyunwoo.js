var booking = (function() {
	...
	var search_result_form = function(page_num) {
		$.ajax({
			...
			type : 'POST',
			data : {'location':$('#location').val(),'checkin':$('#checkin').val(),'checkout':$('#checkout').val(),'guestCnt':$('#guests option:selected').val(),'pageNum':1},
			dataType : 'json',
			async : false,
			success : function(data){
				...
				+'<input id="datespan-checkin" type="text" name="start" class="checkin input-contrast" value="'+start+'" placeholder="체크인">'
				+'</div>'
				+'<div class="col-md-4 col-sm-6 space-1-sm">'
				+'<label class="screen-reader-only" for="datespan-checkout">체크아웃</label>'
				+'<input id="datespan-checkout" type="text" name="end" class="checkout input-contrast" value="'+end+'" placeholder="체크아웃">'
				+'</div>'
				+'</div>'
...
+'<div class="col-md-4 col-sm-6 space-1-sm">'
+'<label class="screen-reader-only" for="datespan-checkin">체크인</label>'
+'<input id="datespan-checkin" type="text" name="start" class="checkin input-contrast" value="2016/10/14" placeholder="체크인">'
+'</div>'
+'<div class="col-md-4 col-sm-6 space-1-sm">'
+'<label class="screen-reader-only" for="datespan-checkout">체크아웃</label>'
+'<input id="datespan-checkout" type="text" name="end" class="checkout input-contrast" value="2016/10/26" placeholder="체크아웃">'
+'</div>'
+'</div>'
+'<div class="col-md-4 col-sm-12 space-sm-1">'
+'<div class="select select-block">'
