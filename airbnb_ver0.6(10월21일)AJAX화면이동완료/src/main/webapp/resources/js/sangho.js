...
var booking = (function() {
	...
	var onCreate = function() {
		...
		$('#pub_article').on('click','#detail_go',function(){
			...
			$('button[name=paying_go]').click(function() {
				var detail = {
					'checkin_date' : $('#checkin_date').val(),
					'checkout_date' : $('#checkout_date').val(),
					'guest_cnt' : $('#guest_cnt option:selected').val()
				}
				$.ajax({
					url : app.context()+'/booking/detail',
					type : 'POST',
		...
		$('#pub_article').on('click','button[name=paying_go]',function(e){
			...
			///////////////////////////////////////
			$('#paying_complete').click(function() {
				var paying = {
					'card_num' : $('#card_number').val(),
					'payment_seq' : $('#card_m').val(),
...
+'<input type="text" id="card_number" maxlength="19" name="credit-card-number" value="text" class="first-message-input invalid">'
+'</div>'
...
+'<div class="terms media">'
 ...
 +'<label name="form" for="agrees-to-terms" class="va-container">'
  ...
  +'<input type="checkbox" id="bt_agrees" name="agree" value="1" onClick="agreeCheck(this.form)>'
  +'</div>'
...
+'<button id="paying_complete" class="btn btn-large btn-primary disabled" name="bt_paying" value="요청 보내기" disabled>'
+'</div>'
+'</div>'
+'<div class="hide">'
+'<div class="space-1">'
